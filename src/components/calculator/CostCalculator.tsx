...
export default function CostCalculator() {
    ...
    return (
        <div className="flex flex-col xl:flex-row gap-8 text-sm text-slate-600 dark:text-slate-300 font-sans">

            {/* --- LEFT PANEL: CONFIGURATION --- */}
            <div className="flex-1 bg-white/50 dark:bg-slate-900/50 p-4 sm:p-6 md:p-8 rounded-3xl border border-black/5 dark:border-white/5 shadow-2xl backdrop-blur-sm">

                {/* GLOBAL TEAM SETTINGS */}
                <div className="mb-8 p-4 bg-cyan-500/5 dark:bg-cyan-950/20 rounded-xl border border-cyan-500/10">
                    <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-slate-900 dark:text-white font-mono font-bold text-lg">{state.teamSize}</span>
                    </div>
                    <input
